...
//user need to pass jwt-token to access data which is retrieved from this end
//task 4:Secure API Endpoint for Authenticated Users Only
//task 2: Create API Endpoints for Data Retrieval
//successfully executed task 4 and 2 with this endpoint
//fetchUser is the middleware function which is helpful to identify the authorized request
...
//here using Infura, which provides access to Ethereum and IPFS nodes via APIs
